...
import com.sodao.dubbo.t6.HelloService;
...
public class DubboConsumer {
	static class Task extends Thread {
		com.sodao.dubbo.t6.HelloService.Iface service;
		public Task(com.sodao.dubbo.t6.HelloService.Iface service) {
	...
	public static void main(String[] args) throws Exception {
		...
		final com.sodao.dubbo.t6.HelloService.Iface service = (HelloService.Iface) ctx.getBean("helloService");
//		for (int i = 0; i < 10; i++) {
